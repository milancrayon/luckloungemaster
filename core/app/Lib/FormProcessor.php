...
class FormProcessor {
    ...
    public function optionValidation() {
        $validation['rules'] = [
            'option_generator.identifier.*' => 'required|in:required,optional',
        ];
        $validation['messages'] = [
            'option_generator.identifier.*.required'   => 'All is required field is required',
            'option_generator.identifier.*.in'         => 'Is required field is invalid',
        ];
        return $validation;
    }
