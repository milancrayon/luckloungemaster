...
class WithdrawController extends Controller
{
    ...
    public function withdrawSubmit(Request $request)
    {
        ...
        return to_route('user.withdraw.view', ['id' => $withdraw->id])->withNotify($notify);
    ...
    { 
        $data = Withdrawal::with('method','user')->where('id', $id)->first();
        abort_if(!$data, 404); 
        $pageTitle = 'Withdrawal Detail'; 
        return view('Template::user.withdraw.view', compact('data', 'pageTitle'));
