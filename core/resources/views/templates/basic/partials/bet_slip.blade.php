...
<div class="betslip">
    ...
    <div class="betslip__footer" id="betSlipBody">
        ...
        <div class="betslip__footer-bottom d-flex align-items-center">
            ...
            <div class="place-btn">
                <button class="btn btn--danger btn--md sm-text betslip__footer-btn bet-place-btn betPlaceBtn" type="button">
                    @lang('PLACE BET')
                </button>
            </div>
        </div>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title text-light">@lang('Confirmation Alert')</h5>
                ...
                <form id="betForm" action="{{ route('user.bet.place') }}" method="POST">
                    ...
                    <div class="modal-body">
                        ...
                        <p class="text-dark">@lang('Are you sure to place bet')?</p>
                    </div>
                    <div class="modal-footer">
                        <button class="btn btn--light" data-bs-dismiss="modal" type="button">@lang('No')</button>
                        <button class="btn btn--dark" type="submit">@lang('Yes')</button>
                    </div>
                </form>
            </div>
        </div>
