    ...
    <div class="container">
        <div class="row" id="game-start-area">
            <div class="col-md-6">
                ...
                <div class="mobile_top_menu">
                    <img class="h-100" src="{{ asset($activeTemplateTrue . 'images/blackjack-preview.png') }}"
                        alt="@lang('image')">
                </div>
            </div>
            <div class="col-md-6">
                    ...
                    <form id="game" method="post">
                        ...
                        <div class="d-flex d-md-block flex-wrap">
                            ...
                            <div class="mt-5 text-center">
                                <button class="cmn-btn w-100 game play-btn" id="flip"
        ...
        <div class="row d-none" id="game-result-area">
            ...
            <div class="back-blackjack d-flex justify-content-center d-none mt-4 gap-4">
                ...
                <a class="btn btn--base play-again-btn" data-bs-toggle="modal"
                    data-bs-target="#reAmountAsk">@lang('Play Again')</a>
            </div>
...
<div class="modal fade" id="reAmountAsk" role="dialog" aria-labelledby="reAmountAskTitle" aria-hidden="true"
    tabindex="-1">
    <div class="modal-dialog modal-dialog-centered modal-md" role="document">
        <div class="modal-content section--bg">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLongTitle">@lang('Add Amount')</h5>
                <button class="btn-close" data-bs-dismiss="modal" type="button" aria-label="Close"></button>
            </div>
            <div class="modal-body">
                <form id="gamepopup" method="post">
                    @csrf
                    <div class="d-flex d-md-block flex-wrap">
                        <div class="form-group text-center">
                            <div class="input-group mb-3">
                        ...
                        <div class="mt-5 text-center">
                            <button class="cmn-btn w-100 game " id="flip" type="submit">@lang('Play Now')</button>
                        </div>
                    </div>
                </form>
...
@push('script')
    <script>
        ...
        $('#gamepopup').on('submit', function (e) {
            e.preventDefault();
            var data = $(this).serialize();
            var url = "{{ route('user.play.game.invest', 'blackjack') }}";
            game(data, url);
