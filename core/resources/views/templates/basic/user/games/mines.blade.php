...
@section('content')
<section class="pt-120 pb-120 common_game_wrapper mines_wrapper">
    <div class="container">
        <div class="row">
            <div class="col-md-6">
            ...
            <div class="col-md-6 mt-md-0 mt-5">
                <div class="card custom--card right_box">
                    <div class="card-body">
                        <h3 class="f-size--28 mb-4 text-center">@lang('Current Balance :')
                            <span class="base--color"><span
                                    class="balance">{{ showAmount(auth()->user()->balance, currencyFormat: false) }}</span>
                                {{ __(gs('cur_text')) }}</span>
                        </h3>
                        <div class="d-flex d-md-block flex-wrap">
                            ...
                            <div class="form-group game_part">
                                ...
                                <input type="number" class="form-control form--control" name="mines" min="1" max="20">
                            </div>
                            <div class="button">
