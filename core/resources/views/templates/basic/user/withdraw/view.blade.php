                ...
                <div class="card">
                    <div class="card-body p-0">
                        ...
                        <div class="row text-center">
                            ...
                            <p>We Will working on your Withdrawal request !!</p>
                        ...
                        <div class="row">
                            ...
                            <div class="col text-end">
                                <p>   {{ showAmount(1) }} = {{ showAmount($data->rate, currencyFormat: false) }} {{ __($data->currency) }}
                                                        <br>
                                                        <strong>{{ showAmount($data->final_amount, currencyFormat: false) }} {{ __($data->currency) }}</strong>
                                                    </strong>
                                </p>
                            </div>
                        </div>
                        ...
                        @php
                            $details = []; 
                            foreach (@$data->withdraw_information ?? [] as $key => $info) {
                                $details[] = $info;
                                if ($info->type == 'file') {
