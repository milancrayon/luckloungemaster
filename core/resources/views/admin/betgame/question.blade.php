                ...
                <div class="card-body">
                    ...
                    <div class="d-flex justify-content-between flex-wrap gap-3">
                        ...
                        <div class="text-end">
                            ...
                            <h6 class="f-size-16px"> {{ showDateTime($game->bet_end_time, 'd M Y, h:i A') }}</h6>
                        </div>
                    </div>
            ...
            function optionTable(options) {
                ...
                $.each(options, function(index, option) {
                    tableRow += `<tr>
                                    ...
                                    <td data-label="@lang('Rate')">${Number(option.odds)}</td>
                                    ...
                                    `<td data-label="@lang('Action')">
                                        ...
                                        ${option.status == 1 ?`<button class="btn btn-sm btn-outline--danger option-status-btn" data-action="{{ route('admin.option.status', '') }}/${option.id}" data-question="@lang('Are you sure to disable this option')?"><i class="la la-eye-slash"></i>@lang('Disable')</button>` : `<button class="btn btn-sm btn-outline--success option-status-btn" data-action="{{ route('admin.option.status', '') }}/${option.id}" data-question="@lang('Are you sure to enable this option')?"><i class="la la-eye"></i>@lang('Enable')</button>`} ${option.locked == 1 ?`<button class="btn btn-sm btn-outline--success option-status-btn" data-action="{{ route('admin.option.locked', '') }}/${option.id}" data-question="@lang('Are you sure to unlock this option')?">
                                                <i class="las la-unlock"></i> @lang('Unlock')
