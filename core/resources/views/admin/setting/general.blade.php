                    ...
                    <div class="row">
                        ...
                        <div class="col-xl-4 col-sm-6">
                            <div class="form-group">
                                ...
                                <select class="select2 form-control" name="paginate_number"
                                    ...
                                    <option value="100" @selected(gs('paginate_number') == 100)>
                                        @lang('100 items per page')</option>
                                </select>
                            </div>
                        </div>
                            ...
                            <div class="form-group ">
                                ...
                                <select class="select2 form-control" name="currency_format"
                                    ...
                                    <option value="1" @selected(gs('currency_format') == Status::CUR_BOTH)>
                                        @lang('Show Currency Text and Symbol Both')</option>
                                    <option value="2" @selected(gs('currency_format') == Status::CUR_TEXT)>
                                        @lang('Show Currency Text Only')</option>
                                    <option value="3" @selected(gs('currency_format') == Status::CUR_SYM)>
                                        @lang('Show Currency Symbol Only')</option>
                                </select>
                            </div>
                        </div>
                        <div class="col-xl-4 col-sm-6">
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    <input class="form-control" name="single_bet_min_limit" type="number"
                                        value="{{ getAmount(gs('single_bet_min_limit')) }}" step="any" min="0" required>
                                    <span class="input-group-text">{{ gs('cur_text') }}</span>
                                </div>
                            </div>
                        </div>
                        <div class="col-xl-4 col-sm-6">
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    <input class="form-control" name="single_bet_max_limit" type="number"
                                        value="{{ getAmount(gs('single_bet_max_limit')) }}" step="any" min="0" required>
                                    <span class="input-group-text">{{ gs('cur_text') }}</span>
                                </div>
                            </div>
                        </div>
                        <div class="col-xl-4 col-sm-6">
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    <input class="form-control" name="multi_bet_min_limit" type="number"
                                        value="{{ getAmount(gs('multi_bet_min_limit')) }}" step="any" min="0" required>
                                    <span class="input-group-text">{{ gs('cur_text') }}</span>
                                </div>
                            </div>
                        </div>
                        <div class="col-xl-4 col-sm-6">
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    <input class="form-control" name="multi_bet_max_limit" type="number"
                                        value="{{ getAmount(gs('multi_bet_max_limit')) }}" step="any" min="0" required>
                                    <span class="input-group-text">{{ gs('cur_text') }}</span>
                                </div>
                            </div>
                        </div>
