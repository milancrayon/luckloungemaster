                                    ...
                                    <div class="col-lg-12">
                                        ...
                                        <div class="card border--primary mt-3">
                                            <div class="card-header bg--primary d-flex justify-content-between">
                                                <h5 class="text-white">@lang('Options')</h5>
                                                <button type="button" class="btn btn-sm btn-outline-light float-end option-generate-btn"> <i class="la la-fw la-plus"></i>@lang('Add New')</button>
                                            </div>
                                            <div class="card-body">
                                                <x-options-form />
                                            </div>
